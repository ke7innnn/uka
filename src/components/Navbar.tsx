      ...
      <div className="fixed bottom-6 right-6 md:bottom-8 md:right-8 z-[50] flex flex-col md:flex-row-reverse gap-3 items-end md:items-center">
        ...
        >
          <img 
            ...
            alt="Chat Assistant" 
            className="w-[84px] h-[84px] md:w-[96px] md:h-[96px] object-contain"
          />
        </button>
        ...
        >
          <div className="absolute inset-0 flex items-center justify-center text-white group-hover:text-black transition-colors duration-300">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-[30px] h-[30px] md:w-[36px] md:h-[36px]">
      ...
      <AnimatePresence>
        {isChatOpen && (
          <motion.div
            ...
            className="fixed bottom-[116px] right-6 md:bottom-[140px] md:right-8 z-[60] w-[320px] md:w-[360px] bg-[#0a0a0a]/95 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl overflow-hidden flex flex-col"
          >
            {/* Header */}

...
export default function GoodiesContact() {
  ...
  return (
    <div id="goodies-contact" className="horizontal-section w-screen min-h-screen h-auto md:h-screen flex-shrink-0 relative flex flex-col justify-between bg-black text-white px-6 md:px-32 py-16 md:py-24 gap-12">
      <div className="flex flex-col mt-4 md:mt-0">
        <motion.h2
          ...
          viewport={{ once: true }}
          className="font-serif text-4xl md:text-8xl mb-8 md:mb-16"
        >
          Resources & Contact
        </motion.h2>
          ...
          <div className="flex flex-wrap gap-x-3 gap-y-2 mb-8">
            {contactText.map((word, i) => (
              <motion.span
                ...
                viewport={{ once: true }}
                className="font-serif text-2xl md:text-5xl italic"
              >
                {word}
              </motion.span>
            ))}
